...
| CHIRPS v3 Daily SAT | Curah hujan | Dinamis harian, turunan pentad |
| Sentinel-1 SAR | Proksi kelembapan tanah dan biomassa | Dinamis jarang, revisit 6-12 hari |
| Google Dynamic World | Tutupan lahan dan probabilitas kelas | Dinamis temporal, 2-5 hari revisit, rawan cloud cover |
| Peta gambut | Faktor kerentanan statik | Statik |

**Data yang sengaja tidak digunakan pada tahap pertama**

Sentinel-2 mentah ditolak karena resolusi 10 m terlalu berat untuk grid 5 km, sering tertutup awan, dan menambah beban preprocessing tanpa kontribusi proporsional. Namun produk turunan Sentinel-2 berupa Google Dynamic World diterima karena menyediakan tutupan lahan serta probabilitas kelas yang sudah diproses menjadi label siap pakai, sehingga beban preprocessing tidak ditanggung peneliti. MODIS NDVI ditunda ke fase berikutnya. GPM ditolak karena redundan dengan CHIRPS.

**Klarifikasi sifat data harian CHIRPS**

CHIRPS pada dasarnya adalah produk pentad, yaitu agregat 5 harian, dan bulanan. Nilai harian bukan observasi langsung, melainkan hasil disagregasi statistik dari total pentad menggunakan pola temporal dari sumber lain. CHIRPS v3 menyediakan dua varian harian, yaitu varian reanalysis 'rnl' yang menggunakan presipitasi harian ERA5 untuk mempartisi total pentad, dan varian satelit 'sat' yang menggunakan presipitasi harian dari IMERG untuk tujuan yang sama.

**Pemilihan varian 'sat', bukan 'rnl'**

Dokumen ini secara eksplisit memilih varian 'sat', berbasis IMERG, bukan varian 'rnl' yang berbasis ERA5. Alasannya adalah independensi statistik antar sumber data. Penelitian ini juga memakai ERA5-Land sebagai sumber cuaca terpisah pada pasal ini. Apabila varian 'rnl' dipakai, channel curah hujan harian akan sebagian diturunkan dari pola ERA5, sehingga tidak lagi independen secara statistik dari channel ERA5-Land yang juga dipakai sebagai fitur. Redundansi turunan semacam ini dapat mendistorsi interpretasi SHAP pada RQ3, karena kredit kontribusi dapat terbagi secara semu antara dua channel yang sebenarnya membawa sebagian sinyal yang tumpang tindih. Varian 'sat' yang berbasis IMERG tidak berbagi sumber turunan dengan ERA5-Land, sehingga risiko ini berkurang.

**Konsekuensi yang diterima secara sadar**

Nilai curah hujan harian yang dipakai penelitian ini tetap merupakan hasil disagregasi, bukan pengukuran langsung per hari. Variasi hari ke hari di dalam satu pentad sebagian mencerminkan pola dari IMERG, bukan murni sinyal CHIRPS. Keterbatasan ini harus dinyatakan eksplisit pada bagian data dan metodologi paper, bukan disamarkan seolah CHIRPS adalah observasi harian independen.

**Justifikasi CHIRPS dibanding pemakaian IMERG mentah secara langsung**

CHIRPS varian 'sat' dipilih sebagai sumber curah hujan primer dengan resolusi spasial 0.05 derajat, setara sekitar 5 km, mendekati resolusi grid penelitian ini. IMERG mentah tanpa melalui CHIRPS menawarkan resolusi temporal 30 menit yang secara fisik lebih relevan untuk gambut, karena hujan deras berdurasi pendek dapat menjenuhkan lapisan permukaan dan mengubah kelembapan tanah secara tiba-tiba, sesuatu yang tidak sepenuhnya tertangkap oleh nilai harian hasil disagregasi CHIRPS. Namun IMERG mentah memiliki resolusi spasial lebih kasar yaitu sekitar 11 km, dan menambahkannya sebagai channel keenam pada tahap ini mengulang risiko kompleksitas prematur yang sama seperti alasan penolakan Sentinel-2 pada penyusunan awal.

Perlu dicatat bahwa CHIRPS varian 'sat' yang dipilih pada dokumen ini sudah memasukkan informasi temporal dari IMERG secara tidak langsung, melalui proses disagregasi pentad ke harian. Dengan demikian, sebagian nilai tambah temporal IMERG sudah terwakili tanpa perlu menambah channel terpisah. IMERG mentah dengan resolusi sub harian penuh tetap dicatat sebagai kandidat future extension pada pasal 15, dengan trigger eksplisit apabila residual model menunjukkan pola yang konsisten dengan kejadian hujan sub harian intens yang tidak tertangkap oleh nilai harian hasil disagregasi.
...
| --- | --- | --- |
| Dinamis temporal | ERA5-Land, CHIRPS, Dynamic World | Channel penuh, bervariasi tiap hari. Dynamic World memiliki mask ketersediaan cloud terpisah karena rawan cloud cover di Riau. |
| Dinamis jarang | Sentinel-1 | Channel dengan mask ketersediaan terpisah, lihat O4b |
| Statik spasial | Gambut | Di broadcast ke seluruh dimensi waktu sebagai channel konstan |
...
**Penanganan Dynamic World**

Dynamic World merupakan produk turunan Sentinel-2 yang menyediakan probabilitas kontinu (0 hingga 1) untuk sembilan kelas tutupan lahan pada setiap pengambilan gambar. Tidak seperti WorldCover yang berupa peta statik, Dynamic World bervariasi antar waktu dan rawan cloud cover pada musim kebakaran Riau.

Karena itu Dynamic World diperlakukan sebagai channel dinamis temporal penuh, sama seperti ERA5-Land dan CHIRPS, bukan sebagai channel statik. Sembilan channel probabilitas kelas dimasukkan langsung sebagai nilai kontinu, bukan one hot encoding, karena probabilitas sudah berada pada skala yang bermakna dan tidak memerlukan kategorisasi tambahan. Pendekatan ini juga memberi informasi ketidakpastian: apabila probabilitas kelas tersebar merata pada suatu hari, model dapat belajar bahwa label pada hari tersebut tidak dapat diandalkan.

Konsekuensi yang diterima secara sadar adalah bahwa sebagian hari pada musim kebakaran akan memiliki data Dynamic World yang hilang akibat awan, karena Dynamic World merupakan turunan Sentinel-2 yang tidak menembus awan. Pola missingness ini harus dilaporkan secara eksplisit, serupa dengan kewajiban pelaporan pada channel Sentinel-1 di O4b, dan metode pengisian gap mengikuti ketentuan yang sama pada O4 yaitu split sebelum imputasi serta statistik dari data train saja.
...
**Resolution Trigger** Analisis pola missingness selesai untuk ERA5, CHIRPS, dan Dynamic World.
...
**L10. Redundansi turunan tersembunyi antar sumber data**
Sumber data yang tampak independen dapat berbagi proses turunan yang sama, sehingga dua channel yang dianggap terpisah sebenarnya membawa sebagian sinyal yang tumpang tindih. Pada penelitian ini, risiko utamanya adalah pemilihan varian CHIRPS harian yang berbasis ERA5, yang apabila dipakai akan membuat channel curah hujan tidak independen secara statistik dari channel ERA5-Land. Risiko ini bukan kebocoran label dalam pengertian L1 hingga L9, melainkan kebocoran independensi antar fitur, yang dapat mendistorsi interpretasi SHAP pada RQ3 dengan membagi kredit kontribusi secara semu antara dua channel yang saling berkorelasi karena sumber turunan yang sama. Setiap kali sumber data baru ditambahkan ke desain ini, asal usul turunannya wajib diperiksa terhadap sumber data yang sudah ada, bukan hanya diperiksa terhadap ketersediaan dan formatnya.
...
| CHIRPS v3 SAT daily | | harian, turunan pentad | GeoTIFF, NetCDF, atau via GEE | v3.0 |
| Sentinel-1 | | 6-12 hari, revisit tidak tetap | GeoTIFF atau GRD | |
| Dynamic World | | 2-5 hari, turunan Sentinel-2, rawan cloud cover | GeoTIFF, via GEE | v1 |
...
| Data sources | FIRMS, ERA5-Land termasuk swvl1 dan swvl2, CHIRPS v3 varian sat berbasis IMERG, Sentinel-1, Dynamic World, gambut | DECIDED |
...
| Fitur statik | Broadcast sebagai channel konstan, hanya gambut yang statik | DECIDED |
| Fitur dinamis temporal | ERA5-Land, CHIRPS, Dynamic World sebagai channel temporal penuh | DECIDED |
